...
console.log(sectionPadTopAndBot + ' sectionPadTopAndBot');
...
function cmdCheck(x, y) {
  ...
  if (sectionArticleNo > 1) {
    ...
    var myNode = cmdInputIdDom.getElementsByClassName('section-no-dots')[0];
    ...
    for ( i=0; i<sectionArticleNo; i++) {
      ...
      cmdInputIdDom.getElementsByClassName('section-no-dots')[0].appendChild(cln);
    }
