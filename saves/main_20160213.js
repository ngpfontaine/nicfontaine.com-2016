...
// onkeypress="javascript:return false;" onkeydown="javascript: return function();"
...
// (NOTE) MAYBE MAKE A LOOP FOR BELOW TO GRAB MENU ARTICLE H2s
  ...
  document.querySelector('#cmd-input-hidden').addEventListener('keydown', function (e) {
    ...
    if (e.which == 8) {
      ...
      if (backEnable) {
        ...
        $(this).val($('input').val().substring(0,$('input').val().length-1));
  ...
  $('#cmd-input-hidden').keyup(function(e) {
      ...
      if(e.keyCode === 13 &&  cmdInput !== "" && cmdInput) {
        ...
        // LIST ALL
          ...
          cmdListUpdate += "> " + cmdInput + "<br><br>" + "&nbsp; > ABOUT<br>" + "&nbsp; > GAMES<br>" + "&nbsp; > WEB<br>" + "&nbsp; > ART<br>" + "&nbsp; > CONTACT<br>" + "&nbsp; > RESUME<br><br>";
          cmdList.innerHTML = cmdListUpdate;
          cmdClear();
          cmdCheck("ls", 400);
