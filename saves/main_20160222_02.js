...
var upKeyupEnable = true;
var downKeyupEnable = true;
var scrollAmt = 5;
...
(function($) {
  ...
  document.addEventListener('keydown', function (e) {
    ...
    // DOWN
      ...
      downKeyupEnable = true;

      function scrollAnim() {
        //
        console.log('scrollAnim()');
        scrollTopStartClass.scrollTop += scrollAmt;
        scrollCallDown = requestAnimationFrame(scrollAnim);
        // UPDATE W/ SCROLL
      ...
      if (downKeydownEnable) {
        ...
        downKeyupEnable = true;
        //
        console.log(downKeydownEnable + ' downKeydownEnable');
      ...
      document.addEventListener('keyup', function(f) {
        if (f.which == 40) {
          if (downKeyupEnable) {
            //
            console.log('firing down keyup');
            downKeyupEnable = false;
            //
            console.log(downKeyupEnable + ' downKeyupEnable');
            downKeydownEnable = true;
            //
            console.log(downKeydownEnable + ' downKeydownEnable');
            // STOP SCROLL ANIM
            window.cancelAnimationFrame(scrollCallDown);
            //
    ...
    // UP
      ...
      function scrollAnim() {
        scrollTopStartClass.scrollTop -= scrollAmt;
        scrollCallUp = requestAnimationFrame(scrollAnim);
      ...
      document.addEventListener('keyup', function(f) {
        if (f.which == 38) {
          if (upKeyupEnable) {
            ...
            window.cancelAnimationFrame(scrollCallUp);
